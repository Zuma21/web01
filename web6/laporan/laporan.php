...
<?php
    ...
    include 'functions/functionLaporan.php';     // menginput data php dari folder lain
...
<body>
    ...
    <div class="container">
        ...
        <button class="btnTambah dnone" id="btnTambah"><a href="tambahDataLaporan.php">Tambah Data</a></button>
    </div>
